...
const contacts = [
    {
        ...
        "account": {
            "id": 69,
            "name": "Hermann, Renner and Wilkinson"
        },
        "createdBy": {
            "id": 6,
    ...
    },
    {
        ...
        "account": {
            "id": 174,
            "name": "Wehner, Hodkiewicz and Howe"
        },
        "createdBy": {
            "id": 1,
    ...
    },
    {
        ...
        "account": {
            "id": 244,
            "name": "D'Amore, Huels and Wilkinson"
        },
        "createdBy": {
            "id": 7,
    ...
    },
    {
        ...
        "account": {
            "id": 55,
            "name": "Medhurst, Osinski and Kiehn"
        },
        "createdBy": {
            "id": 11,
            "username": "julee.tomasini"
...
const defaultFilterValue = [
  ...
  { name: 'city', operator: 'inlist', type: 'select', value: ['New York City', 'Boston'] }
];

const columns = [
  { name: 'id', defaultWidth: 50, type: 'number' },
